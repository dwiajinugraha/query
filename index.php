    ...
    <div class="w3-row-padding" style="margin:0 -16px">
      <div class="w3-half w3-margin-bottom">
        <ul class="w3-ul w3-white w3-center w3-opacity w3-hover-opacity-off">
          ...
          <li class="w3-padding-16">14.01.53.0012</li>
          <li class="w3-padding-16">Dwi Aji Nugroho</li>
      ...
      <div class="w3-half">
        <ul class="w3-ul w3-white w3-center w3-opacity w3-hover-opacity-off">
          ...
          <li class="w3-padding-16">14.01.53.0019</li>
          <li class="w3-padding-16">Faisal Guruh Leksono</li>
          <li class="w3-padding-16">Fakultas Teknologi Informasi</li>
          <li class="w3-padding-16">S1-Teknik Informatika</li>
        ...
        <ul class="w3-ul w3-white w3-center w3-opacity w3-hover-opacity-off">
          ...
          <li class="w3-padding-16">14.01.53.0050</li>
          <li class="w3-padding-16">Gilar Tahta .F.P</li>
          <li class="w3-padding-16">Fakultas Teknologi Informasi</li>
          <li class="w3-padding-16">S1-Teknik Informatika</li>
